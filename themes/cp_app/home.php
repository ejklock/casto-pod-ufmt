...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/styles/ufmt.css" />
</head>
...
<body class="flex flex-col min-h-screen mx-auto bg-base theme-<?= service('settings')
    ...
    <header class="py-8 px-8 text-white border-b bg-header border-subtle header-ufmt">
        <h1 class="container flex items-center justify-between px-2 py-4 mx-auto pod-title">
            <a href="<?= route_to(
                            'home',
                        ) ?>" class="inline-flex items-baseline text-3xl font-semibold font-display"><?= service('settings')
                                                                                                            ->get('App.siteName') === 'Castopod' ? 'castopod'  : esc(service('settings')
                                                                                                                ->get('App.siteName')) ?></a>
        </h1>
        <div class="content">

            <img src="assets/images/logo_ufmt.svg">
            <img src="assets/images/logo_setec.svg">
        </div>
    </header>
    ...
    <footer class="px-2 py-4 mx-auto text-sm text-right border-t border-subtle footer-ufmt">
        <a href="https://ufmt.br" target="_blank"><img src="assets/images/ufmt-icon.svg"></a>

        <div class="social-icons-block">
            <p class="social-title">Nossas Redes Sociais</p>
            <ul>

                <li><a href="https://www.instagram.com/ufmt.br" target="_blank"><img src="assets/images/instagram.svg"></a> </li>
                <li><a href="https://web.facebook.com/ufmatogrosso" target="_blank"><img src="assets/images/facebook.svg"></a> </li>
                <li><a href="https://twitter.com/UFMT" target="_blank"><img src="assets/images/twitter.svg"></a> </li>
                <li> <a href="https://www.youtube.com/channel/UC5MHS3vY3J2FHWwkAgvSZlw" target="_blank"><img src="assets/images/youtube.svg"></a> </li>
            </ul>
        </div>
